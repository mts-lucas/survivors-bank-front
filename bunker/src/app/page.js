...
export default function Home() {
  return (
    <div className="flex items-center justify-center bg-black bg-opacity-70 shadow-lg p-6 rounded-[5%] flex-col md:m-10 lg:m-20">
      ...
      <div className='m-8 lg:m-16 xl:m-24'>
        <p className='text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-red-600 font-semibold text-4xl md:text-5xl lg:text-6xl text-justify'>
